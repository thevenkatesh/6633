...
func NewCommand() *cobra.Command {
	...
	command.Flags().StringSliceVar(&metricsApplicationRevisions, "metrics-application-revisions", env.StringsFromEnv("ARGOCD_METRICS_APP_REVISIONS", []string{"HEAD", "main", "master", "develop"}, ","), "List of Application revisions that will be added to the argocd_app_info metric")
